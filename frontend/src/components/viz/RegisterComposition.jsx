 ...
 * distribution bars and tabular counts.
 */
export default function RegisterComposition({ stats }) {
  ...
  return (
    <div className="space-y-3.5">
      <div className="flex items-center justify-between text-[11.5px] text-[var(--text-3)] pb-2 border-b border-[var(--edge)]">
            ...
            <li key={`${c.name}-${i}`} className="group">
              <div className="flex items-baseline justify-between gap-3">
                ...
                <div className="flex items-center gap-6 shrink-0">
                  ...
                  <span className="num text-[12px] text-[var(--text-3)] w-12 text-right">
                    {share}%
                  </span>
                </div>
              </div>
